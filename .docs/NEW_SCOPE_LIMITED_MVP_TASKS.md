...
2. Build a complete coarse catalog capped by the lesser of 2 million primitives, 5% of valid source primitives (with a defined nonzero policy for tiny valid models), and the reserved GPU budget. Verified scene bounds still require the complete scan.
